...
import { diffAgainstBase, fillFromParents, newMasterId, validateMasterHorse } from '../core/master-edits';
...
interface Form { overseas: boolean; name: string; price: string; purchasePrice: string; breedingRightPrice: string; color: string; bigSystem: string; smallSystem: string; unlock: string; hidden: boolean; priceUnknown: boolean; ancestors: string[]; attrs: Record<string, string> }
